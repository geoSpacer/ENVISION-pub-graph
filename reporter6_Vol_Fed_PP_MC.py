    ...
    for scenario in runList:
        ...
        for volSpp in ['','_PP','_MC']:
            ...
            if os.path.isdir(inDir):
                ...
                pl.figure(1)
                mnAxis, mxAxis = reporterFunc.plotReporter4(fig, ax, '', pdfFile, dataTable, ['mean','lower','upper'], xLabelText, yLabelText, 'HarvVol' + volSpp, labelXtick, labelYtick, plotLegend, scenario)
                pl.figure(2)
                mnAxis, mxAxis = reporterFunc.plotReporter4(fig2, ax2, '', pdfFile2, dataTable, ['cum_mean'], xLabelText, yLabelText2, 'HarvVol' + volSpp, labelXtick, labelYtick, plotLegend, scenario)
