...
#    PMG12345Ha = reporterFunc.getPMG12345Ha(subArea)
    ...
    pdfFile = PdfPages(outDir + 'report5_PMG12345_HS_Fire_byOwner.pdf')
...
#        elif plotPage == 2:
    ...
    reporterFunc.plotFigureText(fig, 'Simulation year', 'Forested area burned (%)')

    pl.savefig(outDir + 'report5_PMG12345_HS_Fire_byOwner.png', bbox_inches='tight', dpi=300)
    pdfFile.savefig()
    pl.close()
    pdfFile.close()
    print "Done."
