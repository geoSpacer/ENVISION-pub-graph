...
import reporter6_ForestStructure2_landscape
...
import reporter6_syu_Vol_Owners
import reporter6_Vol_Fed_PP_MC
import reporter6_syu_Vol_Fed_PP_MC

def main():
    subArea = 'Southeast'
    chartTitle = 'Southeast_20180105'
...
#    runList = ['North_20170621_NoMgmt','North_20170606_CurrentPolicy','North_20170611_Goodfires50','North_20170605_FuelBreak300','North_20170615_Timber','North_20170617_HRV','North_20170617_WildfireMgmt','North_20170619_Wildlife']
    runList = ['Southeast_20171225_NoMgmt','Southeast_20171229_CurrentPolicy','Southeast_20180102_Goodfire','Southeast_20180105_Timber2']

##    reporter6_Management_area.main(outDir, subArea, runList, chartTitle, 'All')
##    reporter6_Management_area_2x2.main(outDir, subArea, runList, chartTitle, 'All')
...
##    reporter6_ForestStructure2_landscape.main(outDir, subArea, runList, chartTitle, 'All')
...
##    reporter6_smoke.main(outDir, subArea, runList, chartTitle, 'All')
    reporter6_Vol_Fed_PP_MC.main(outDir, subArea, runList, chartTitle, 'Federal')
    reporter6_syu_Vol_Fed_PP_MC.main(outDir, subArea, runList, chartTitle, 'Federal')
...
##    reporter6_syu_Vol_Owners.main(outDir, subArea, runList, chartTitle, 'All')
##    reporter6_Management_area.main(outDir, subArea, runList, chartTitle, 'SYU')
##    reporter6_Management_area_2x2.main(outDir, subArea, runList, chartTitle, 'SYU')
##
