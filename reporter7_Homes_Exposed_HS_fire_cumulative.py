...
def main(outDir, runList, statsFile):
    ...
    for scenario in runList:
        ...
        if os.path.isdir(inDir):
            ...
            appendFrame = pd.DataFrame(data=[{'Policy': scenario, 'VarGroup': 'Fire', 'Variable': 'CumulativeHomesExpHSFire_dwellings', 'Year1': dataTable[dataTable['timeStep'] == 1]['cum_mean'].iloc[0], 'Year25': dataTable[dataTable['timeStep'] == 25]['cum_mean'].iloc[0], 'Year49': dataTable[dataTable['timeStep'] == 49]['cum_mean'].iloc[0]}])
