...
#    PMG345Ha = reporterFunc.getPMG345Ha(subArea)
    ...
    pdfFile = PdfPages(outDir + 'report5_Volume_byOwner.pdf')
...
#        elif plotPage == 2:
                ...
                for year in range(1,max(yearList) + 1):
                    ...
                    for rep in repList:
                        ...
                        if ownership == 'USFS':
                            ...
                            fireProneArea = PMG12345Ha['ODF Gilchrist']
    ...
    reporterFunc.plotFigureText(fig, 'Simulation year', 'Total merchantable harvest volume ( $\mathregular{1x10^3}$ $\mathregular{m^3}$)')

    pl.savefig(outDir + 'report5_Volume_byOwner.png', bbox_inches='tight', dpi=300)
    pdfFile.savefig()
    pl.close()
    pdfFile.close()
    print "Done."
