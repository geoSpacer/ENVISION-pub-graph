...
#        elif plotPage == 2:
    ...
    reporterFunc.plotFigureText(fig, 'Simulation year', 'Fire prone landscape in high severity fire (%)')

    pl.savefig(outDir + 'report5_HS_Fire_byOwner.png', bbox_inches='tight', dpi=300)
    pdfFile.savefig()
    pl.close()
    pdfFile.close()
    print "Done."
