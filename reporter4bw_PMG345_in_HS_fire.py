...
def main(outDir, subArea, runName, chartTitlePre, ownership):
    ...
    if ownership == 'All':
        ...
        pdfFile = PdfPages(outDir + 'report4bw_PMG345_in_HS_Fire_' + ownersToGraph[0] + '.pdf')
    ...
    ownerArea['CP_HS_pct'] = (ownerArea[varList[0]] + ownerArea[varList[1]] + ownerArea[varList[2]]) / fireProneArea * 100
    ownerArea['NFT_HS_pct'] = (ownerArea[varList[0] + '_x'] + ownerArea[varList[1] + '_x'] + ownerArea[varList[2] + '_x']) / fireProneArea * 100
    ownerArea['Res_HS_pct'] = (ownerArea[varList[0] + '_y'] + ownerArea[varList[1] + '_y'] + ownerArea[varList[2] + '_y']) / fireProneArea * 100
    ...
    for splot in [1, 2]:
        ...
        print 'median for No treatment fed ' + str(np.median(valueSet[1]))
        print 'median for Restoration ' + str(np.median(valueSet[2]))
        print
